	...
	return (
		<nav className="sticky top-0 z-50 bg-white/75 dark:bg-[#0f0c1b]/75 backdrop-blur-md border-b border-purple-100 dark:border-[#31255c]/50 px-6 py-4 transition-colors duration-500">
			<div className="max-w-7xl mx-auto flex justify-between items-center">
				...
				{/* LOGO */}
				<Link to="/" className="flex items-center gap-2 text-xl font-extrabold text-transparent bg-clip-text bg-linear-to-r from-purple-600 to-pink-600 dark:from-purple-400 dark:to-pink-400 drop-shadow-[0_0_15px_rgba(168,85,247,0.2)] dark:drop-shadow-[0_0_15px_rgba(168,85,247,0.4)] hover:opacity-90 transition-opacity">
