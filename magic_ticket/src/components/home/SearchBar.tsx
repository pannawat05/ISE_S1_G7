...
export default function SearchBar() {
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center w-full max-w-3xl mx-auto bg-[#1a1a1a] border border-white/10 rounded-full overflow-hidden">
